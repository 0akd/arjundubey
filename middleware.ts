...
const PUBLIC_PATHS = ['/test','/register','/iframe','/music','/leetcode','/word','/display','/donate', '/login','/views', '/organise','/progress', '/blog','/about','/projects','/','/education','/stats/mental','/stats/spirit','/logout','/rout','/footr','/webby','/admin/blog'];
