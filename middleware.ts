...
const PUBLIC_PATHS = ['/test','/resume','/products','/learn','/reality','/register','/iframe','/music','/leetcode','/word','/display','/donate', '/login','/views', '/organise','/progress', '/blog','/about','/projects','/','/education','/stats','/logout','/rout','/footr','/webby','/admin/blog'];
