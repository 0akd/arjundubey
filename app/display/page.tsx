    ...
    <div className="w-full max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 text-lg">
          Real-time progress tracking across personal development categories
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {categoryData.map((category) => {
          ...
          return (
            <div
              key={category.name}
              className={`${config.bgColor} p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1`}
            >
              <div className="text-center">
                <div className="mb-4">
                  <CircularProgress
      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-8 rounded-xl border">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-6 text-gray-800">Overall Achievement</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-gray-600">Total Tasks Set</div>
            </div>
