...
export default function DownloadPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      <h1 className="text-3xl md:text-2xl font-semibold mb-12 md:mb-8 text-center">Application Version 1</h1>
      <a
        href="https://mkw3xpovahzkrpq2.public.blob.vercel-storage.com/product/arjundubey.apk"
        download
